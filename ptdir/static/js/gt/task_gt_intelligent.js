...
function sleep(milliseconds) {
  ...
  for (var i = 0; i < 1e7; i++) {
    ...
    /* welcome message */
    var page_1 = '<h2>Welcome to the face intelligence rating HIT!</h2> ' +
		'<p>Your task is to guess <strong>how intelligent</strong> a person looks <b>in most people\'s eyes</b>.</p>' +
    ...
    var page_4 = '<p>You will get a quick notice about your progress after every 10 faces.</p>' +
        ...
        '<p>Do not press until the face is loaded. Try to finish it within 30 minutes.</p>' +
    ...
    //     "How trustworthy does this person look to you?</strong></p>";
    //
    // var bold_phrase = 'How trustworthy does this person look to you?';
    ...
    //     required: [require_or_not],
    //     button_label: 'Continue',
    //     placeholders: ['How trustworthy does this person look to you?'],
 ...
 *                           empty face
 * ========================================================================= */
var prompty_que = '<p>How <b>intelligent</b> does this person look to <b>most people</b>? Rate from 1-9</p>';

var labels = ["1 <br/>Not intelligent at all",
             "2", "3", "4", "5", "6", "7", "8",
             "9  <br/>Extremely intelligent"];
 ...
 * ========================================================================= */
 var feedback_for_interview = {
     type: 'survey-text-req',
     questions: ['What features do you use to judge intelligence?',
