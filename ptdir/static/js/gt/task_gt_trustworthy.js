...
function sleep(milliseconds) {
  ...
  for (var i = 0; i < 1e7; i++) {
    ...
    /* welcome message */
    var page_1 = '<h2>Welcome to the face trustworthyness rating HIT!</h2> ' +
...
var labels = ["1 <br/>Not trustworthy at all",
             "2", "3", "4", "5", "6", "7", "8",
             "9  <br/>Extremely trustworthy"];
 ...
 * ========================================================================= */
 var feedback_for_interview = {
     type: 'survey-text-req',
     questions: ['What features do you use to judge trustworthyness?',
