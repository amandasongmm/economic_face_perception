...
function sleep(milliseconds) {
  ...
  for (var i = 0; i < 1e7; i++) {
    ...
    var page_3 = '<p>You will see 100 faces. You may see the same face more than once.</p>' +
        '<p> Watch carefully and make consistent ratings.</p>' +
        '<p>Your HIT will be accepted if more than <b>80%</b> of your responses align with the majority and more than <b>70%</b> of your ' +
    ...
    var page_4 = '<p>You will get a quick notice about your progress after every 10 faces.</p>' +
        '<p>Try to use the full scale and rate people all the way from 1 to 9. </p>' +
