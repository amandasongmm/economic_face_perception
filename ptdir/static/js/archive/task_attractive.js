...
function sleep(milliseconds) {
  ...
  for (var i = 0; i < 1e7; i++) {
    ...
    var exp_mode = 'debug'; // 'debug', 'sandbox', 'live'
    ...
    /* welcome message */
    var page_1 = '<h2>Welcome to the face attractive experiment!</h2> ' +
		'<p>In this experiment, you will see some facial photos. </p> ' +
		'<p>Your task is to rate <strong>how attractive</strong> the person looks to you on a <strong>1-9</strong> scale.</p>';
    ...
    var page_4 = '<p>You will get a quick notice about your progress after every 10 faces.</p>' +
        '<p>Try to use the <strong>entire 1-9 scale</strong>  through out the task.</p>' +
    ...
    var target_question = "<p><strong>" +
        "How attractive does this person look to you?</strong></p>";

    var bold_phrase = 'How attractive does this person look to you?';
    ...
    var comprehension_question = {
        ...
        required: [require_or_not],
        button_label: 'Continue',
        placeholders: ['How attractive does this person look to you?'],
 ...
 *                           empty face
 * ========================================================================= */
var prompty_que = '<p>How attractive does this person look to you? Rate from 1-9</p>';
 ...
 * ========================================================================= */
 var feedback_for_interview = {
     type: 'survey-text-req',
     questions: ['What features do you use to judge attractiveness?',
