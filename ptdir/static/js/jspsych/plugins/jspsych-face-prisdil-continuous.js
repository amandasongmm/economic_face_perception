...
jsPsych.plugins['face-prisdil-continuous'] = (function() {
	var plugin = {};

	plugin.info = {
		name: 'face-prisdil-continuous',
		description: '',
		parameters: {
			questions: {
	...
	plugin.trial = function(display_element, trial) {
		...
		// add slider
		// slider source: https://www.w3schools.com/howto/howto_js_rangeslider.asp (circular)
		trial_form.innerHTML += `<div class="""slidecontainer">
