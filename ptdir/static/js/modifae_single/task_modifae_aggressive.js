...
function sleep(milliseconds) {
  ...
  for (var i = 0; i < 1e7; i++) {
    ...
    var task_name = 'aggressive-modifae-single';
    ...
    /* welcome message */
    var page_1 = '<h2>Welcome to face aggressiveness HIT!</h2> ' +
		'<p>Your task is to guess <strong>how aggressive</strong> a person looks <b>in most people\'s eyes</b>.</p>' +
 ...
 *
 * ========================================================================= */
var prompty_que = '<p>How <b>aggressive</b> does this person look to <b>most people</b>? Rate from 1-9</p>';

var labels = ["1 <br/><b>Not aggressive at all</b>",
             "2", "3", "4", "5", "6", "7", "8",
             "9  <br/><b>Extremely aggressive</b>"];
