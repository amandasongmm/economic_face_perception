...
function sleep(milliseconds) {
  ...
  for (var i = 0; i < 1e7; i++) {
    ...
    var task_name = 'attractive-modifae-single';
    ...
    /* welcome message */
    var page_1 = '<h2>Welcome to face attractiveness HIT!</h2> ' +
		'<p>Your task is to guess <strong>how attractive</strong> a person looks <b>in most people\'s eyes</b>.</p>' +
 ...
 *
 * ========================================================================= */
var prompty_que = '<p>How <b>attractive</b> does this person look to <b>most people</b>? Rate from 1-9</p>';
